...
def main():
    ...
    cli.add_argument("<input_file>", help="the input file to parse")
    cli.add_argument("--dump-ir", help="whether to dump intermediate representation to JSON", action="store_true", default=False)
    cli.add_argument("--outfile", help="name or path for the parsed JSON output file", type=str, action="store")
    ...
    api.parse(infile=args.input_file, dump_ir=args.dump_ir, outfile=outfile)
